...
+ SCAN_LIST_BYTES + PAGE_MAP_BYTES + INPUT_BUF_BYTES + OUTPUT_BUF_BYTES)
...
#define INPUT_BUF_ADDR		(TEMP_BUF_ADDR + TEMP_BUF_BYTES)					// general purpose buffer
#define INPUT_BUF_BYTES		(1024 * 1024)

#define OUTPUT_BUF_ADDR		(INPUT_BUF_ADDR + INPUT_BUF_BYTES)					// general purpose buffer
#define OUTPUT_BUF_BYTES	(16 * 1024 * 1024)
